...
### Line Type (for Line and Area series)

Line and Area series support a `lineType` option that controls how the line is drawn:
...
Series markers support the following shapes:

- `circle` - A circular marker
- `square` - A square marker  
- `arrowUp` - An upward-pointing arrow
- `arrowDown` - A downward-pointing arrow
