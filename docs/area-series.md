...
|`lineType`|[LineType](./constants.md#linetype)|`LineType.Simple`|Line type (Simple, WithSteps, or WithGaps)|
...
- set initial options for area series:
    ...
    ```js
    // Example with WithGaps line type
    const areaSeriesWithGaps = chart.addAreaSeries({
        topColor: 'rgba(21, 146, 230, 0.4)',
        bottomColor: 'rgba(21, 146, 230, 0)',
        lineType: LightweightCharts.LineType.WithGaps,
    });
    
    // Set data with gaps (null values)
    areaSeriesWithGaps.setData([
        { time: '2018-12-22', value: 32.51 },
        { time: '2018-12-23', value: null }, // This creates a gap
        { time: '2018-12-24', value: 27.02 },
        { time: '2018-12-25', value: 27.32 },
        { time: '2018-12-26', value: null }, // Another gap
        { time: '2018-12-27', value: 28.89 },
    ]);
    ```
